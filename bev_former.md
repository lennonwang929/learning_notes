...
## Transformer与子空间聚类
子空间聚类是找到与某个向量相关性较大的一组其他向量，这些向量可以通过线性组合表示这个向量，通过注意力权重对这些向量进行线性组合会生成一个新向量，而这个新向量与原来的这个向量会很相似，但又有细微的差别，从而通过这种方式生成新向量
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzNzE4MTI5Niw2NzgwNDY0NTYsLTIwMT
E5Mjc1NTIsOTIwNjQ5NzY0LC0yMDc2MTAzNzgzLDgyNDQ3ODY1
NSwxNTkzMTY0MzYwLC04NzE5NDA0OTQsLTE1MjY0NTM0NTMsOD
