...
2. **键（Key）**：键向量 k_ 代表输入特征x_i 的一种特征表示，用于与查询进行相似度计算。它用于衡量输入特征与查询的相关性。

3. **值（Value）**：值向量 v_ 是最终需要加权汇聚的输入特征信息，通常和键 k_ 一起从输入特征 x_ 中生成。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjgzODUwMjgsLTIwNzYxMDM3ODMsMT
U5MzE2NDM2MCwtMTUyNjQ1MzQ1Myw4NTY0NTcwNTAsNDYxNzQx
ODUsODkwMDg1MDE1LC01OTA3MzAxNTUsLTIwNDg0MjcwNywxNj
YwOTc0MTcyLC0xMTk2NTkzMzI3XX0=
-->